<script>
    ...
    const initializeChart = () => {
      ...
      const updateChart = () => {
        // Get the current expenses from the store.
        ...
        if (chart) {
          ...
          // Use black (#000000) in light mode for text.
          chart.options.plugins.legend.labels.color = darkMode ? '#E5E7EB' : '#000000';
          chart.update();
        } else {
          chart = new Chart(ctx, {
            type: 'doughnut',
    ...
    const handleColorSchemeChange = (e) => {
      ...
      if (chart) {
        ...
        chart.options.plugins.tooltip.titleColor = darkMode ? '#E5E7EB' : '#000000';
        chart.options.plugins.tooltip.bodyColor = darkMode ? '#E5E7EB' : '#000000';
  ...
  <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg transition-colors duration-300">
    <h2 class="text-xl font-semibold text-black dark:text-gray-100 mb-4">Expense Breakdown</h2>
